      ...
      <div className="max-w-md w-full text-center">
        <div className="mx-auto h-24 w-24 text-indigo-600">
          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-full h-full">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29.82-5.709 2.291M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
        </div>
