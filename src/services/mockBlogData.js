...
export const MOCK_POSTS = [
  {
    ...
    excerpt:
      'Learn the new features and improvements in React 19, including Server Components, Concurrent Features, and more.',
    content:
      '<h2>Introduction to React 19</h2><p>React 19 brings exciting new features...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Comprehensive guide to React 19 new features, Server Components, and migration tips for developers.',
  ...
  },
  {
    ...
    excerpt:
      'Discover the latest CSS features and best practices for modern web development.',
    ...
    seo: {
      ...
      metaDescription:
        'Learn the latest CSS techniques including Grid, Flexbox, and modern layout methods for 2024.',
  ...
  },
  {
    ...
    excerpt:
      'Learn how to build and scale Node.js applications for production environments.',
    content:
      '<h2>Architecture Patterns</h2><p>Microservices and monolithic approaches...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Complete guide to building and scaling Node.js applications with best practices and patterns.',
  ...
  },
  {
    ...
    content:
      '<h2>Design Fundamentals</h2><p>Color theory, typography, and layout...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Learn essential UI/UX design principles to create better user interfaces and user experiences.',
  ...
  },
  {
    ...
    excerpt:
      'Master TypeScript with advanced features, best practices, and real-world examples.',
    content:
      '<h2>Advanced Types</h2><p>Utility types, conditional types, and more...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Master TypeScript with advanced features, utility types, and best practices for enterprise development.',
  ...
  },
  {
    ...
    excerpt:
      'Complete guide to building cross-platform mobile apps with React Native.',
    content:
      '<h2>Getting Started</h2><p>Setting up the development environment...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Learn to build cross-platform mobile apps with React Native from setup to deployment.',
  ...
  },
  {
    ...
    excerpt:
      'Compare Django and FastAPI frameworks for Python web development projects.',
    content:
      '<h2>Framework Comparison</h2><p>Performance, features, and use cases...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Detailed comparison of Django and FastAPI for Python web development with pros and cons.',
  ...
  },
  {
    ...
    excerpt:
      'Exploring how AI and ML are transforming modern web development practices.',
    content:
      '<h2>AI Integration</h2><p>APIs, libraries, and practical applications...</p>',
    ...
    seo: {
      ...
      metaDescription:
        'Learn how to integrate AI and machine learning into web applications with practical examples.',
...
export const getPosts = (filters = {}) => {
  ...
  if (filters.author && filters.author !== 'all') {
    if (filters.author === 'me') {
      ...
      filteredPosts = filteredPosts.filter(
        post => post.author.id === parseInt(filters.author)
      );
    }
  }
  ...
  if (filters.category && filters.category !== 'all') {
    filteredPosts = filteredPosts.filter(
      post => post.category.id === parseInt(filters.category)
    );
  }
