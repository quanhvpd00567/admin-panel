  ...
  return (
    <div className="fixed bottom-4 right-4 bg-gray-800 text-white p-4 rounded-lg shadow-lg text-xs max-w-sm">
      ...
      <div className="space-y-1">
        <div><span className="text-gray-300">Mode:</span> {ENV.NODE_ENV}</div>
        <div><span className="text-gray-300">App:</span> {ENV.APP_NAME}</div>
        <div><span className="text-gray-300">Version:</span> {ENV.APP_VERSION}</div>
        <div><span className="text-gray-300">API:</span> {ENV.API_BASE_URL}</div>
